...
const PANCAKESWAP_LIST = 'https://tokens.pancakeswap.finance/pancakeswap-extended.json';
const TRUST_CDN = 'https://assets-cdn.trustwallet.com/blockchains/smartchain/assets';
...
async function loadTokens(): Promise<Token[]> {
  ...
  try {
    const res = await fetch(PANCAKESWAP_LIST);
