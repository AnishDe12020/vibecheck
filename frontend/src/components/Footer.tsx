      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-4 pt-4 border-t border-zinc-800/20 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-zinc-600">
          <div className="flex items-center gap-3 flex-wrap justify-center">
            <a href="https://github.com/AnishDe12020/vibecheck" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-400 transition-colors flex items-center gap-1">
            ...
            <span className="text-zinc-800">•</span>
            <a href="https://dorahacks.io/buidl/39575" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-400 transition-colors">DoraHacks</a>
          </div>
        ...
        <div className="mt-3 pt-3 border-t border-zinc-800/20 flex flex-col sm:flex-row items-center justify-between gap-2 text-[10px] text-zinc-700">
          <span>🤖 Powered by AI (Gemini) + opBNB Attestation</span>
          <span>© {new Date().getFullYear()} VibeCheck · Not financial advice. Always DYOR.</span>
        </div>
      </div>
    </footer>
  );
