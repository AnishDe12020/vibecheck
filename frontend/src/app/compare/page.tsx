...
export default function ComparePage() {
  useEffect(() => { document.title = 'VibeCheck — Compare Tokens'; }, []);
  ...
  return (
    <div className="flex-1 max-w-6xl mx-auto w-full px-3 sm:px-6 py-8 sm:py-12">
      <div className="mb-8 sm:mb-10 text-center hero-glow relative z-10">
        ...
        <p className="text-zinc-500 max-w-md mx-auto text-sm sm:text-base">Analyze two BSC tokens side-by-side to find the safer play.</p>
      </div>
